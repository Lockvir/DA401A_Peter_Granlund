...
public class SecondScreen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("SecondScreen", "onCreateView");
    ...
    private void GetQuote()
    {
        ...
        String[] quote = getResources().getStringArray(R.array.not_so_epic_quotes);
        String currentQuote = quote[random.nextInt(quote.length)];

        TextView textView = (TextView) getView().findViewById(R.id.quote_field);
        textView.setText(currentQuote);

        Log.i("SecondScreen", currentQuote);
